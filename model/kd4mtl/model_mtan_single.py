...
nyuv2_train_set = NYUv2(root=dataset_path, train=True, augmentation=opt.apply_augmentation)
nyuv2_test_set = NYUv2(root=dataset_path, train=False, augmentation=opt.apply_augmentation)
