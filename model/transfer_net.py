...
class TaskTransferNet(nn.Module):
    ...
    def __init__(self, in_features, out_features, features=[64, 128, 256], batch_norm=False):
        ...
        self.dec2 = TTUp(in_features=features[1], out_features=features[0], batch_norm=batch_norm)
        self.dec3 = TTUp(in_features=features[0], out_features=features[0], batch_norm=batch_norm)
...
class TaskTransferNetWithSkipCN(nn.Module):
    ...
    no transferred features from y_b decoder
    """
    def __init__(self, in_features, out_features, features=[64, 128, 256], batch_norm=False, wider_ttnet=False):
        super().__init__()
        if wider_ttnet:
