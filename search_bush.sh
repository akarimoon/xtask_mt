...
python model/mtan/model_segnet_mtan_nyu.py --dataroot data/nyu_preprocessed/ -n 2 --weight uncert
python model/mtan/model_segnet_mtan_nyu.py --dataroot data/nyu_preprocessed/ -n 3 --weight uncert
